...
| C080-B | GPU count, plan, and grouped proxy schedule | IN_PROGRESS | Strict expert-to-server CPU oracle is frozen: 11/11 plus old planner 38/38 pass, C061 gives 33 copies/six moves, and segments are destination-bucketed 5-int records. GPU count/plan/prefix kernels remain. |
| C080-C | Minimal force arena and collective preflight | IN_PROGRESS | The checked 32B/2MiB force arena formula and EP8 size agreement pass. Cross-rank preflight/status and runtime C<=1024/D<=32 checks remain; public force stays unavailable. |
