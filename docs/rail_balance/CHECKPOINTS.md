...
| C080-D | Shared-core LSA data path without a supplied manifest | IN_PROGRESS | The direct-final moved-only LSA/TMA kernel passes true 8-GPU raw TokenLayout comparison for C061 multi-copy plus all-owner C1024/D32/K4 and exact Pcap, including non-default stream and inactive-slot preservation. H7168, fault injection, and 4x2/2x4 round trips remain acceptance gates. |
