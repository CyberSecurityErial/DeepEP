...
| C080-D | Shared-core LSA data path without a supplied manifest | IN_PROGRESS | The direct-final moved-only LSA/TMA kernel passes true 8-GPU raw TokenLayout comparison for C061, all-owner C1024/D32/K4, H7168, reverse arena reuse, exact Pcap, corrupt-plan fail-closed/recovery, non-default streams, and inactive-slot preservation. Focused mem/sync/device-init checks report zero errors; racecheck retains six explained WAW warnings. 4x2/2x4 GPU round trips and return-unshuffle remain acceptance gates. |
